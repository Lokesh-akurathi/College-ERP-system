...
public class CourseService {
    ...
    /**
     * NEW: Create section using List<SectionTime> instead of a dayTime string.
     */
    public String createSection(int courseId,
        ...
        section.setSemester(semester);
        section.setYear(year);
        section.setTimes(times);                      // <-- IMPORTANT NEW LINE
    ...
    /**
     * NEW: update method must use List<SectionTime>.
     */
    public String updateSection(Section section) {
