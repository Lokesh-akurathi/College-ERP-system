...
public class AdminService {
    ...
    /**
     * UPDATED: uses List<SectionTime> instead of old dayTime string.
     */
    public String updateSection(int sectionId,
        ...
        section.setSemester(semester);
        section.setYear(year);
        section.setTimes(times);   // IMPORTANT NEW FIELD
    ...
    /**
     * UPDATED: deleteSection now calls sectionStore.canDeleteSection()
     * AND the correct delete method in SectionStore.
     */
    public String deleteSection(int sectionId) {
